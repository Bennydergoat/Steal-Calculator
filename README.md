...
1. **Select Ore Tier:** Choose the base rarity of your ore (Common to Divine).
2. **Choose Mutation:** Click on the mutation type to apply the specific multiplier.
...
To later locate the Project or delete it, search for C:\Users\YOURUSERNAMEHERE the folder labled Steal-Calculator
...
[shield-discord-server]: https://img.shields.io/discord/1487497522267164744?logo=discord&logoColor=white&label=discord&color=4d3dff
